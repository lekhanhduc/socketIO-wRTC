...
export default function ChatHeader({
    ...
    return (
        <div className="px-6 py-4 border-b border-emerald-100 bg-white shadow-sm">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-1">
                    <button
                        onClick={onAudioCall}
                        className="p-2.5 text-gray-500 hover:text-emerald-600 hover:bg-emerald-50 rounded-full transition-all duration-200 group"
                        title="Gọi thoại"
                    >
